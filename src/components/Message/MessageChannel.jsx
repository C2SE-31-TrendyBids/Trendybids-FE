...
const MessageChannel = ({conversation}) => {
    ...
    return (
        <div className="h-full w-full lg:w-msg-channel-lg md:w-msg-channel-md flex flex-col overflow-hidden relative">
            ...
            {openSearch && (
                <div className="absolute top-[60px] w-full flex items-center gap-x-4 px-3 py-2 rounded-b-lg border-t-[1px] border-b-[1px] border-gray-300 bg-white drop-shadow z-50">
                    <input
                        type="text"
