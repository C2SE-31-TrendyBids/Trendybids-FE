...
const Header = () => {
  ...
  const { auth, user, isLogin } = useContext(AuthContext);
  ...
  const handleLogout = async () => {
    try {
      const token = localStorage.getItem("access-token"); // Lấy token xác thực từ local storage hoặc bất kỳ nơi nào bạn lưu trữ nó
            ...
            <div className="relative">
              ...
              >
                ...
                <img
                  ...
                  src={user?.avatarUrl || "https://cdn-icons-png.flaticon.com/512/6596/6596121.png"}
