...
const TopUpWallet = ({ setOpenModal }) => {
            ...
            <div className='grid grid-cols-2 gap-2 mt-4'>
                <div className='col-span-1'>
                    ...
                    <div className='flex items-center justify-start text-xl py-4 font-semibold'>
                        ...
                        <span className='ml-2'>Enter the amount</span>
                    </div>
                ...
                <div className='col-span-1'>
                    <div className='flex items-center justify-start text-xl py-2'>LIEU THIEN QUANG</div>
                    <div className='flex items-center justify-start text-xl py-2'>2000$</div>
                    <div className='flex items-center justify-start py-2'>
                        <input type="number" className='w-full border py-2 px-2 rounded-lg border-solid border-gray-800' placeholder='Input amount' />
                    </div>
                    <div className='py-3 border border-solid border-gray-800 rounded-lg text-center shadow-lg mt-4'>
                        <div className='text-5xl flex items-center justify-center p-2 text-[#007bff]'>
                            <BsBank2 />
                        ...
                        >
                            <Box sx={style}>
                                <PaymentQrCode amount={amount} setOpen={setOpen} setStatus={status} />
                            </Box>
                        </Modal>
                    </div>
                </div>
