...
const Contact = () => {
  ...
  return (
    <div className=" mx-auto">
      ...
      <div className="max-w-[1200px] grid sm:grid-cols-2  gap-16 my-20  mx-auto bg-white text-[#333] font-[sans-serif] px-8 sm:px-0">
      ...
      <div className="grid md:grid-cols-4 gap-8 m-28">
        <div className="flex flex-col items-center bg-white">
          ...
          <div className="mt-4 text-center">
            ...
            <p className="text-md tect-gray-400 mt-2"> 123 Main Street, City</p>
          </div>
        </div>
        <div className="flex flex-col items-center bg-white">
          <svg
        ...
        <div className="flex flex-col items-center bg-white">
          ...
          <div className="mt-4 text-center">
            ...
            <p className="text-md tect-gray-400 mt-2">trendybids@example.com</p>
          </div>
        </div>
        <div className="flex flex-col items-center bg-white">
          <svg
