...
const AboutUS = () => {
    return (
        <div className="mb-20">
            ...
            <div class="my-14 px-6 pt-12 font-[sans-serif]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 text-sm leading-6">
                                We are an organization that is not only
                                committed to providing quality products and
                                services but also aims to create positive
                            ...
                            <ul class="list-disc text-sm text-gray-700 space-y-2 pl-4 mt-6">
                                ...
                                <li>Safe and secure auction environment.</li>
            ...
            <div class="p-8 mb-20 flex flex-col items-center justify-center font-[sans-serif] text-[#333]">
                <h2 class="sm:text-3xl text-2xl font-extrabold text-center mb-16 text-blue-600">
                    Application Metrics
                </h2>
                <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 max-lg:gap-12">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 mt-2">
                            User engagement level content and features.
                        </p>
                    </div>
                    <div class="text-center">
                        <h3 class="text-4xl font-extrabold">
            ...
            <div class="mb-20 max-w-4xl mx-auto font-[sans-serif] text-[#333]">
                <h2 class="sm:text-3xl text-2xl font-extrabold text-center mb-16 text-blue-600">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
                    <div class="p-4 text-center">
                        ...
                        <p class="text-gray-500 text-sm">
                            Tailor our product to suit your needs Tailor our
                    ...
                    <div class="p-4 text-center">
                        ...
                        <p class="text-gray-500 text-sm">
                            Tailor our product to suit your needs Expand your
                            reach with our global network.
                        </p>
                    </div>
                    <div class="p-4 text-center">
                        <svg
            ...
            <div class="font-[sans-serif] text-[#333]">
                <div class="sm:max-w-5xl max-w-sm mx-auto ">
                    <div class="max-w-2xl mx-auto text-center text-blue-600 ">
                    ...
                    <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-16 text-center my-28 ">
                        <div class="bg-gray-100 relative rounded hover:scale-110 transition-all duration-500">
                            <img
