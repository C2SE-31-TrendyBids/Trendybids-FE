    ...
    <div className="mb-20">
      <div class="relative w-full ">
        <img
          ...
          alt="About page"
          class="w-full h-[350px] object-cover pixelated"
        />
        <span class="absolute top-40 left-10 lg:top-36 lg:left-[130px] mb-4 text-4xl text-blue-500 font-extrabold drop-shadow-md">
          About Us
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p class="text-gray-700 text-sm leading-6">
                We are an organization that is not only committed to providing
                quality products and services but also aims to create positive
                community engagement and contribute to the development of
                society.
              </p>
        ...
        <div class="sm:max-w-5xl max-w-sm mx-auto ">
          ...
          <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-16 text-center my-28 ">
            <div class="bg-gray-100 relative rounded hover:scale-110 transition-all duration-500">
              ...
              />
              <div class="py-4">
                <h4 class="text-base font-extrabold">Le Xuan Tan</h4>
            ...
            <div class="bg-gray-100 relative rounded hover:scale-110 transition-all duration-500">
              ...
              />
              <div class="py-4">
                <h4 class="text-base font-extrabold">Duong Quang Quoc</h4>
                <p class="text-xs mt-1">Software Engineer</p>
                <div class="space-x-4 mt-4">
                  <button
                    type="button"
            ...
            <div class="bg-gray-100 relative rounded hover:scale-110 transition-all duration-500">
              ...
              />
              <div class="py-4">
                <h4 class="text-base font-extrabold">Pham Huu Sang</h4>
            ...
            <div class="bg-gray-100 relative rounded hover:scale-110 transition-all duration-500">
              ...
              />
              <div class="py-4">
                <h4 class="text-base font-extrabold">Lieu Thien Quang</h4>
                <p class="text-xs mt-1">Web Designer</p>
                <div class="space-x-4 mt-4">
                  <button
                    type="button"
