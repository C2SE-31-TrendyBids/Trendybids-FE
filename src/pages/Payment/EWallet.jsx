    ...
    return (
        <div className="max-w-[1230px] mx-auto px-[30px] h-auto py-4">
            <div className="relative">
                ...
                />
                <div className="text-3xl font-bold absolute top-16 left-3">
                    ...
                    <div className="flex items-center justify-center">
                        <div className="w-4/5 border p-4 font-semibold border-solid border-gray-900 shadow-lg rounded-lg">
                            ...
                            <div className="flex text-xl mt-2">
                                <span>
                                    <GiWallet className="text-xl text-blue-600" />
                                </span>
                                <span className="ml-2">
                            ...
                            <div className="relative text-3xl my-2">
                                <span class="bg-gray-100 flex gap-5 items-center justify-between py-3 px-4 h-[50px] w-[90%] text-base rounded-full">
                                    {showAccount ? (
                                        <>
                                        ...
                                        <h1 className="w-full text-center mt-2 text-3xl">
                                            ******************
                                        </h1>
                                    )}
                                </span>
                ...
                <div className="col-span-6">
                    <div className="flex items-center justify-center">
                        <div className="w-3/5 border p-4 font-semibold border-solid border-gray-900 shadow-lg rounded-lg h-[115px]">
                            <span className="text-xl mb-1 text-blue-600">
                                {" "}
                                TOTAL AMOUNT :{" "}
                            </span>
                            <div className="relative mt-2">
                                ...
                                <span className="absolute right-2 text-3xl top-0">
                                    {showPassword ? (
                                        <MdOutlineVisibility
                                            onClick={() =>
                    ...
                    <div className="flex items-center justify-center">
                        <button
                            className="w-3/5 border p-3 rounded-lg mt-6 font-semibold text-lg border-solid border-green-600 bg-blue-800 text-gray-100 hover:bg-blue-500"
            ...
            <div className="w-full my-4 ">
                <div className="ml-4 text-xl font-bold p-2">
                    E-Wallet Trendy Bids is possible
                </div>
                <div className="grid grid-cols-12 gap-2 mt-4">
                    <div className="col-span-4 flex items-center justify-center">
                        <div
                            className="w-4/5 border py-2 rounded-lg border-solid border-gray-900 cursor-pointer hover:scale-105 hover:border-green-500 shadow-lg  transition-transform duration-300"
